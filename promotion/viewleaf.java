 ...
 * @author Kavinga
 */
public class viewleaf extends javax.swing.JFrame {

    /**
     * Creates new form viewleaf
     */
   public viewleaf() {
        initComponents();
        showData();
    ...
    public void view() {        try {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO banners(lsi,lpri) values (?,?)");
    ...
    private void showData() {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM leaflet");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewleaf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
