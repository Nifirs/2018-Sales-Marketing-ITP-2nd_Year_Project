...
public class Expences extends javax.swing.JFrame {
     ...
     */
    public Expences() throws SQLException  {
        initComponents();
        showData();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vehicle/hom.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      insetExpence a = new insetExpence();
        a.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        updateExpencess a = new updateExpencess();
        a.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        DeleteExpencess a = new DeleteExpencess();
        a.setVisible(true);
        this.setVisible(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            String path = "C:\\Users\\Nilfa.RS\\Documents\\NetBeansProjects\\SalesProject\\src\\vehicle\\expens.jrxml";
...
//            to view report
    ...
    private void showData() throws java.sql.SQLException {
        try {
            DatabaseConnection db = new DatabaseConnection();
            Connection con = db.getConnection();

            PreparedStatement ps = con.prepareStatement("SELECT * FROM expen");
