...
public class viewemployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 420, -1));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photos/delete.png"))); // NOI18N
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        updateemployee up1 = new updateemployee();
        up1.setVisible(true);
        this.disable();
    }//GEN-LAST:event_jLabel11MouseClicked

    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        deleteemployee de1 = new deleteemployee();
        de1.setVisible(true);
        this.disable();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO addemployee(employeeid,basicsalary,otrate) values (?,?,?)");

            PreparedStatement select = con.prepareStatement("SELECT * FROM  addemployee");
